...
import Style from "../financial-modelling-course/course.module.css";
import Link from "next/link";
import { Rating } from "@mui/material";
import "../../component/financial-modelling-course/Buybutton.css";
    ...
    <>
      <section className={Style.hero_banner} id="herobanner">
            ...
            <div className="col-md-6 text-center text-md-start">
              ...
              <>
                <div className="prices_box d-flex flex-wrap justify-content-center justify-content-sm-start">
                  <div className="option active_option flex-wrap text-center ">
                    <div>
        ...
        */}
                      ...
                      >
                        {/* {props?.data?.actual_pricing} */}
                      </h2>
                      {/* <h2 style={{ color: "#3782D9" }}>Free</h2>{" "} */}
                      {/* Offer price */}
                      {/* Uncomment if needed
      ...
      */}
                    ...
                    {props?.data?.btnUrl && (
                      <>
                        ...
                        <p style={{ marginTop: "1rem", marginLeft: "20px" }}>
                          {" "}
