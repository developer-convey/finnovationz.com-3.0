...
import Calculator from "../../calculatorFiles/calculator/calculator-sip-return";
...
import SIP from "../../calculatorFiles/return/sip";
...
const Home = () => {
  ...
  const currentPage = "SIP Return"; // Update this to match the current page name
  ...
  return (
    <div className="App">
      ...
      <div className="othercalculator">
        <OtherCalculators currentPage={currentPage} /> {/* Pass current page */}
      </div>
      <div
        className=""
        style={{
