...
import CalculatorsiCalculate from "../../calculatorFiles/calculator/simple-interest";
import SimpleIntrestDetail from "./details/simple-interest-details";
...
const Home = () => {
  ...
  const currentPage = "Simple Interest";
