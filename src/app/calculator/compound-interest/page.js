...
import CalculatorCompoundInterest from "../../calculatorFiles/calculator/compound-interest";
import CompoundInterestDetails from "./details/compound-interest-details";
...
const Home = () => {
  ...
  const currentPage = "Compound Interest";
