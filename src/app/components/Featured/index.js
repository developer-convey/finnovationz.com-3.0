...
import Culture from "../webinarCulture/Culture";
              ...
              >
                ...
                <div>
                  <div className="card">
                    ...
                    <div className="card-footer d-flex align-items-center justify-content-between pt-3">
                      <div className="d-flex align-items-center news-name">
                        <img loading="lazy" src="/jt-sns.png" alt="" />
                ...
                <div>
                  <div className="card">
                    ...
                    <div className="card-footer d-flex align-items-center justify-content-between pt-3">
                      <div className="d-flex align-items-center news-name">
                        <img loading="lazy" src="/Mint.png" alt="" />
                ...
                <div>
                  <div className="card">
                    ...
                    <div className="card-footer d-flex align-items-center justify-content-between pt-3">
                      <div className="d-flex align-items-center news-name">
                        <img loading="lazy" src="/ET.png" alt="" />
