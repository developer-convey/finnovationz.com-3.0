...
import "../../finClub/style/finance.css";
import "../../finClub/style/finance.module.css";
import MuiltiStepForm from "../../../finClub/components/MuiltiStepForm";
import { useRouter } from "next/navigation";

function Forms({ handleClose }) {
  ...
  return (
    <>
      <MuiltiStepForm handleClose={handleClose} />
    </>
  );
}
