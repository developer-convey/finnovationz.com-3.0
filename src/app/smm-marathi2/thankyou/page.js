        ...
        <div className="imgbackground mt-1" style={{ textAlign: "center" }}>
          ...
          >
            ...
            >
              ...
              <p>
                ...
                Share Market Mastery joining link.
              </p>
              <span className="font-normal text-[22px] md:text-[35px] text-black">
              आमची{" "}
                <span className="text-[#4CAF50]">WhatsApp</span> Community मध्ये join करा 
          ...
          <div className="mt-6 text-black text-[16px] font-normal flex items-start space-x-3">
            ...
            <label className="text-[22px] md:text-[22px] text-left leading-snug">
              ...
              <span className="text-[#00bf63] font-normal"> SMM aspirants.</span>
            </label>
          </div>
          ...
          >
            ...
            >
              ...
              तुम्हाला सर्व <span style={{ color: "#4CAF50" }}>updates</span>इथे मिळतील 
          ...
          >
            <Link
              href="https://chat.whatsapp.com/HFIJiOqgPKK2XlAFIhXNM0               "
              className="aaa"
              style={{
                display: "flex",
                justifyContent: "center",
