...
const WebinarHomeBanner = dynamic(() =>
  import("../../app/components/webinarHomebanner")
);
const Dwebinap = dynamic(() => import("@/app/money-mastery-programme/components/Dwebinap"));
...
function WApp() {
  ...
  return (
    <>
      ...
      {hasScrolled && (
        <Dwebinap formatDate={formatDate} programmeData={programmeData} />
      )}

      {isHomeBannerVisible && <FixedFooter programmeData={programmeData} />}
    </>
  );
}
