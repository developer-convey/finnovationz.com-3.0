...
const router=useRouter()
  ...
  return (
    <div  ref={ref} className="flex justify-center items-center min-h-screen p-4 relative mt-[-100px]  md:mt-[-100px] mb-[-100px]">
