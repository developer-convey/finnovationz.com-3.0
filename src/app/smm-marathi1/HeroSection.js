...
export default function FinnovationBanner({ scrollToContact }) {
  ...
  />
        ...
        <h2 className="text-3xl md:text-6xl md:mt-[100px] md:leading-[70px] leading-[50px] font-semibold text-gray-900">
           <span className="font-extrabold">Share Market</span> <span className="pt-5 md:block"> मध्ये यशाची गुरुकिल्ली </span>
