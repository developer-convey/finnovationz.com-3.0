...
import courseData from "../../../app/commen/coursesdata/course7.json";
...
const courseSchema = {
  ...
  "@type": "Course",
  "name": "Advanced Mutual Fund Course For Financial Planning",
...
function FundamentalAnalysis() {
  ...
  return (
    <>
      <Header bool={true}/>
      <Head>
        <title>Advanced Mutual Fund Course For Financial Planning</title>
        <meta name="keywords" content="Mutual Fund Course" />
        <meta
          name="description"
          content="The advanced mutual fund course teaches how to invest in mutual funds in simple language. Enrol now and start planning for your financial future today"
        />
        <meta
          property="og:title"
