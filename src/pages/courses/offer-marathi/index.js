...
import courseData from "../../../app/commen/coursesdata/course22.json";
...
function ValueInvesting() {
  ...
  return (
    <>
      ...
      <JoinCourse data={courseData.course} title='तुम्ही नेमके काय शिकाल ?' paymentdata={courseData.banner} />
      <Syllabus
      ...
      <Syllabus
        ...
        slideData={1}
        customTitle="Syllabus for Fundamental Analysis "
      />
...
/>
      ...
      <Candidate
        ...
        customTitle="हा course कुणा साठी आहे?"
      />
