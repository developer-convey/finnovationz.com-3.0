...
import courseData from "../../../app/commen/coursesdata/course17.json";
...
function ValueInvesting() {
  ...
  const brochureSetId = "1750826248658"; 
  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta
          name="description"
          content="Master the art of value investing with our Hindi course. Learn how to identify undervalued stocks using proven strategies from legends like Warren Buffett."
        />
        <meta
          property="og:title"
          content="Learn Value Investing Course | Build Long-Term Wealth
          "
        />
        <meta
...
/>*/}
  ...
  dummy="x" paymentdata={courseData.banner} onBrochureClick={handleOpenBrochureModal} />
      {/* <Footer /> */}
      {/*<Brokerfooter />*/}
      <ScrollModal/>
